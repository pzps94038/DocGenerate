...
namespace DocGenerate.Helper.SqlExcelDoc
{
    public static class SheetHelper
    {
        ...
        public static ICell CreateTitleStyleCell(this IRow row, int column, NPOI.SS.UserModel.HorizontalAlignment alignment = NPOI.SS.UserModel.HorizontalAlignment.Left, VerticalAlignment verticalAlignment = VerticalAlignment.Center)
        {
